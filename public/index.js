...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(86), __webpack_require__(48)))
...
var scaleScreen = function scaleScreen(scale) {
...
var appendScaleMeta = function appendScaleMeta() {
    if (screen.width < 570) {
        scaleScreen(0.58);
...
exports.appendScaleMeta = appendScaleMeta;
...
(function() {
    ...
    function lib$es6$promise$asap$$attemptVertx() {
      try {
        var r = require;
        var vertx = __webpack_require__(317);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(117), __webpack_require__(48)))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(48), __webpack_require__(86), __webpack_require__(117)))
...
var _sendAuthData = __webpack_require__(329);

var _sendAuthData2 = _interopRequireDefault(_sendAuthData);

var _toogleAuthMode = __webpack_require__(331);

var _toogleAuthMode2 = _interopRequireDefault(_toogleAuthMode);

var _ifIsMobile = __webpack_require__(121);

var _showHide = __webpack_require__(320);
...
function ready() {
    ...
    // FOR MOBILE DEVICES
    var isMobile = (0, _ifIsMobile.detectMobile)() || false;
    ...
    var hideRecommend = function hideRecommend() {
        orinentChanged = true;
        (0, _showHide.hide)($mobileRecommend);
        (0, _ifIsMobile.appendScaleMeta)();
        (0, _showHide.show)($wrapper);
        if (orinentChanged) {
    ...
    if (isMobile) {
        if (window.screen.orientation.type.match("portrait")) {
            (0, _showHide.show)($mobileRecommend);
    ...
    $logIn.addEventListener("click", function () {
        return (0, _toogleAuthMode2.default)($logIn, $signUp);
    });
    $signUp.addEventListener("click", function () {
        return (0, _toogleAuthMode2.default)($signUp, $logIn);
    });

    $authBtn.addEventListener("click", _sendAuthData2.default);
...
var _checkAuthStatus = __webpack_require__(322);
...
var logInPost = function logInPost(login, password) {
    ...
    }).then(_checkAuthStatus2.default).catch(function (error) {
...
var _logInPost = __webpack_require__(328);

var _logInPost2 = _interopRequireDefault(_logInPost);

var _signUpPost = __webpack_require__(330);

var _signUpPost2 = _interopRequireDefault(_signUpPost);
...
var sendAuthData = function sendAuthData() {
    ...
    switch ($authBtn.getAttribute("mode")) {
        case "log-in":
            (0, _logInPost2.default)(login, password);
            break;
        case "sign-up":
            (0, _signUpPost2.default)(login, password);
            break;
    }
};
...
var signUpPost = function signUpPost(login, password) {
    fetch('/signUp', {
        credentials: 'same-origin',
        method: 'POST',
        headers: {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js?importLoaders=1!../../../node_modules/postcss-loader/index.js!../../../node_modules/stylus-loader/index.js?resolve url!./auth.styl", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js?importLoaders=1!../../../node_modules/postcss-loader/index.js!../../../node_modules/stylus-loader/index.js?resolve url!./auth.styl");
